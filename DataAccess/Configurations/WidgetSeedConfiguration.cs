    ...
    class WidgetSeedConfiguration : IEntityTypeConfiguration<LKP_Widget>
    {
        public void Configure(EntityTypeBuilder<LKP_Widget> builder)
        {
            ...
            builder.HasData(
                ...
                new LKP_Widget { ID = Guid.Parse("c6d20f43-5ae3-4df3-bf37-e657c26d63aa"), Name = "Certificate" },
                ...
                new LKP_Widget { ID = Guid.Parse("7c9e2f10-aa27-41ba-99b2-7a70e7218d21"), Name = "Overview" }
            );
        }
    }
}
