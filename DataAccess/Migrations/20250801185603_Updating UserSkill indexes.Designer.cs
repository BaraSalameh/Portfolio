...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250801185603_Updating UserSkill indexes")]
    partial class UpdatingUserSkillindexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.UserSkill", b =>
                {
                    ...
                    b.HasIndex("UserID", "LKP_SkillID", "CertificateID")
                        .IsUnique()
                        .HasFilter("[CertificateID] IS NOT NULL");

                    b.HasIndex("UserID", "LKP_SkillID", "EducationID")
                        .IsUnique()
                        .HasFilter("[EducationID] IS NOT NULL");

                    b.HasIndex("UserID", "LKP_SkillID", "ExperienceID")
                        .IsUnique()
                        .HasFilter("[ExperienceID] IS NOT NULL");

                    b.HasIndex("UserID", "LKP_SkillID", "ProjectID")
                        .IsUnique()
