    ...
    public class ProjectMappingProfiles : Profile
    {
        public ProjectMappingProfiles()
        {
            ...
            CreateMap<Project, PLQ_Response>()
                ...
                .ForMember(dest => dest.Certificate, opt => opt.MapFrom(src => src.Certificate == null ? null : src.Certificate.LKP_Certificate));
            ...
            CreateMap<LKP_Certificate, PLQ_PS_Certificate>();
