...
{
    public class EducationListQuery : OwnerCollectionQuery<ELQ_Educations> { }

    public class ELQ_Educations
    {
        public Guid ID { get; set; }
        public ELQ_LKP_Institution Institution { get; set; } = null!;
        public ELQ_LKP_Degree Degree { get; set; } = null!;
