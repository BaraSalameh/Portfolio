...
{
    public class UserSkillListQuery : OwnerCollectionQuery<USLQ_Response> { }

    public class USLQ_Response
    {
        public USLQ_LKP_Skill Skill { get; set; } = null!;
    ...
    {
        public Guid ID { get; set; }
        public USLQ_LKP_Institution Institution { get; set; } = null!;
    }
    ...
    {
        public Guid ID { get; set; }
        public USLQ_LKP_Certificate Certificate { get; set; } = null!;
    }
